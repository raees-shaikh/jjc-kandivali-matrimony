                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Form Download</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <p class="label-title">{{ $form_download->name }}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <p class="label-title">{{ $form_download->email }}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="degree3" class="cust-title"
                                                    class="label-title">Mobile No.</label><br>
                                                <p class="label-title">{{ $form_download->mobile_no }}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <p class="label-title">{{ dd_format($form_download->created_at, 'd-m-Y') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
