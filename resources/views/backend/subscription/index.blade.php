            ...
            <div class="statbox widget box box-shadow my-1">
                <div class="widget-header">
                    <div class="row justify-content-between align-items-center mb-1 m-0">
                        ...
                        <div class="col-lg-6 col-md-6   d-flex justify-content-end align-it mt-2 ">
                        ...
                        <div class="col-xl-7 col-lg-12 col-md-7 col-sm-12 mt-2">
                            <form class="form-inline row app_form" action="{{ route('backend.user.index') }}"
                                ...
                                <input class="form-control form-control-sm app_form_input mt-lg-0   ml-md-2 ml-0"
                                    type="text" placeholder="Name/Email/Phone" name="q"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-primary"
                                                href="{{ route('backend.order.show', $subscription->order_id) }}">
                                                {{ $subscription->order_id }}
                                            </a>
                                        </td>
                                        <td>{{ $subscription->order->total_amount }}</td>
                                        <td>{{ dd_format($subscription->start_date, 'd-m-y h:i a') }}</td>
                                        <td>{{ dd_format($subscription->end_date, 'd-m-y h:i a') }}</td>
                                        <td>
                                            @if ($subscription->is_active == 1 && $subscription->end_date > now())
                        ...
                        <div class=" col-lg-12">
                            <div class="col-md-12 text-center align-self-center">
                                <ul class="d-flex  text-center justify-content-center mt-md-2 mt-4 ">
                                    {{ $subscriptions->appends(Request::all())->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
                    </div>
