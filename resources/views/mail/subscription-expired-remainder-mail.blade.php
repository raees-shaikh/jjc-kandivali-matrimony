...
<body
    ...
    <div style="max-width:600px;margin:auto;background:#E2E4F8;padding:1.5em;font-family:sans-serif">
        ...
        <div class="card">
            <div class="inner">
                <img src="frontend/image/red-bell.png" alt="" class="img">
                <p class="text-center">Hey! Your Subscription is expired, <br> Please renew.</p>
                <p class="cust-text">If already renewed, please ignore it.</p>
            </div>
        </div>
