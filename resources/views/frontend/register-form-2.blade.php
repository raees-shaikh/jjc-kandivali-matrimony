...
@section('content')
    ...
    <section class="mb-4 detail-form px-md-0 px-3">
        <div class="register-form-container container p-3 py-4 p-md-5">
            <legend class="text-center h3"> Details Of Mosal</legend>
                    ...
                    <div class="row">
                        ...
                        <div class="row justify-content-center m-0">
                            <div class="col-12 my-3">
                                <legend class="text-center h3">Two References Who Know About You / Your Family</legend>
                            </div>
                            <div class="col-10">
                                <div class="row justify-content-between ">
                                    <div class="col-md-5 bg-grey box-gray ">
                                        <div class="row ">
                                            <div class="col-12">
                                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 bg-grey box-gray mt-md-0 mt-5">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                        ...
                        <div class="row mt-5 m-0">
                            <legend class="text-center h3 mb-3"> Family Details</legend>
                            <div class="col-md-6 ">
                                <div class="row ">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                        ...
                        <div class="row justify-content-center mt-4 m-0">
                            <legend class="text-center h3">Candidate's Special Choice</legend>
                            <div class="col-md-8 bg-grey p-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="choice_of_life_partner"
                                        ...
                                        <option>Select Any If Required</option>
                        ...
                        <div class="row m-0 mt-5">
                            <legend class="text-center h3">Mumbai Contact For Outside Candidate</legend>
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-8 mt-md-3 mt-0">
                                    <div class="form-group">
                                        ...
                                        <textarea name="mumbai_contact_address" id="mumbai_contact_address" class="form-control" minlength="3"
                                ...
                                <div class="col-md-10 mt-3">
                                    <div class="box-white p-md-5 p-2">
                                        ...
                                        <div class="  mt-5 agree-checkbox" >
                                            ...
                                            <small class="agree-text d-inline-block">I have read and agree to the terms and conditions.</small></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" id="submit"
                                    class="btn btn-gradient mx-auto btn-block px-5">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
