...
@section('content')
    ...
    <section class="mb-4 px-md-0 px-3 ">
        <div class="register-form-container container p-3 py-4 p-md-5 custom-padding-for-desk">
            <legend class="font-weight-600 pb-3">Personal Details</legend>
                ...
                <form id="register-form" action="{{ route('frontend.form-one.store') }}" method="POST"
                    ...
                    <div class="row ">
                        <div class="col-xl-4 col-md-6">
                            ...
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="mobile_number" id="mobile_number"
                                    placeholder="Enter You Mobile No." class="form-control" minlength="10" maxlength="10"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-md-0 pt-3">
                                ...
                                <input type="email" name="email" id="email" placeholder="Enter Your Email ID"
                                    class="form-control" minlength="3" maxlength="30" value="{{ old('email') }}"
                                    required>
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group pt-4">
                                ...
                                <input type="text" name="native_place" id="native_place"
                                    placeholder="Enter your place" class="form-control" minlength="3" maxlength="30"
                                    value="{{ old('native_place') }}" required>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control" aria-label="Small" name="no_of_children"
                                        value="{{ old('no_of_children') ?? '0' }}" required min="0"
                                        max="99">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border-0 bg-white text-black h-100 ">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="sub_caste" id="sub_caste" placeholder="Enter Your Sub Caste"
                                    class="form-control" value="{{ old('sub_caste') }}" minlength="3" maxlength="30">
                        ...
                        <div class="col-xl-4 col-md-6 ">
                            <div class="form-group pt-3 res-add">
                                ...
                                <textarea name="residential_address" required class="form-control" minlength="3" maxlength="120"
                                    id="residential_address" cols="30" rows="4">{{ old('residential_address') }}</textarea>
                                @if ($errors->has('residential_address'))
                                    <div class="text-danger" role="alert">{{ $errors->first('residential_address') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3 res-add">
                                ...
                                <textarea type="text" name="occupation_address" id="occupation_address" class="form-control" rows="2"
                                    minlength="3" maxlength="120">{{ old('occupation_address') }}</textarea>
                    ...
                    <div class="text-center mt-5">
                        <button type="submit" id="submit"
                            class="btn rounded btn-gradient mx-auto
                        btn-block px-5 py-2">
                            Next
                        </button>
                    </div>
