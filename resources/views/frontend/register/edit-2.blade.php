    ...
    <section class="mb-4 detail-form px-md-0 px-3">
        <div class="register-form-container container p-3 py-4 p-md-5 custom-padding-for-desk">
            ...
            <div class="register-form-wrap">
                <form id="register-form" action="{{ route('frontend.form-two.update') }}" method="post">
                    @csrf
                    <div class="row mx-auto  justify-content-center">
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="mosal_name" id="mosal_name" placeholder="Enter Full Name"
                                    class="form-control" value="{{ old('mosal_name') ?? $user->mosal_name }}" minlength="3"
                            ...
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="mosal_mobile" id="mosal_mobile"
                                    ...
                                    value="{{ old('mosal_mobile') ?? $user->mosal_mobile }}" minlength="10" maxlength="10">
                        ...
                        <div class="col-xl-7  mt-0">
                            <div class="form-group res-add pt-3">
                                ...
                                <textarea name="mosal_residential_address" id="mosal_residential_address" class="form-control"
                                    placeholder="Enter Mosal Address" minlength="3" maxlength="120">{{ old('mosal_residential_address') ?? $user->mosal_residential_address }}</textarea>
                        ...
                        <div class="row justify-content-center m-0">
                            <div class="col-12 my-3 px-0 mt-5 mb-4">
                                <legend class="text-center mb-2 font-weight-600">Two References Who Know About You / Your Family</legend>
                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reference_one_name" id="reference_one_name"
                                                        ...
                                                        value="{{ $userReferenceOne ? $userReferenceOne->name : '' }}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reference_one_mobile"
                                                        ...
                                                        class="form-control"
                                                        value="{{ $userReferenceOne ? $userReferenceOne->mobile : '' }}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reference_two_name"
                                                        ...
                                                        class="form-control"
                                                        value="{{ $userReferenceTwo ? $userReferenceTwo->name : '' }}"
                                                        minlength="3" maxlength="30" required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reference_two_mobile"
                                                        ...
                                                        class="form-control"
                                                        value="{{ $userReferenceTwo ? $userReferenceTwo->mobile : '' }}"
                                                        minlength="10" maxlength="10" required>
                                        ...
                                        <div class="form-group pt-3">
                                            ...
                                            <select class="form-control" id="father_occupation" name="father_occupation">
                                                ...
                                                @else
                                                    @foreach (App\Models\User::OCCUPATION as $occu)
                                                        <option value="{{ $occu }}"
                                                            @if ($user->father_occupation == $occu) {{ 'selected' }} @endif>
                                                            {{ $occu }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="form-group pt-3">
                                            ...
                                            <select class="form-control" name="mother_occupation" id="mother_occupation">
                                                ...
                                                @else
                                                    @foreach (App\Models\User::MOTHER_OCCUPATION as $occu)
                                                        <option value="{{ $occu }}"
                                                            @if ($user->mother_occupation == $occu) {{ 'selected' }} @endif>
                                                            {{ $occu }}
                                                        </option>
                                                    @endforeach
                                                @endif
                        ...
                        <div class="row justify-content-center mt-4 m-0">
                            <legend class="text-center mb-3 mt-4 font-weight-600 px-0">Candidate's Special Choice</legend>
                            <div class="col-md-8 box-gray-custom  mt-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="choice_of_life_partner"
                                        ...
                                        @else
                                            <option value="Never Married"
                                                @if ($user->choice_of_life_partner == 'Never Married') {{ 'selected' }} @endif>Never Married
                                            </option>
                                            <option value="Separated"
                                                @if ($user->choice_of_life_partner == 'Separated') {{ 'selected' }} @endif>Separated
                                            </option>
                                            <option value="Widowed"
                                                @if ($user->choice_of_life_partner == 'Widowed') {{ 'selected' }} @endif>Widowed
                                            </option>
                                            <option value="Divorced"
                                                @if ($user->choice_of_life_partner == 'Divorced') {{ 'selected' }} @endif>Divorced
                                            </option>
                                        @endif
                                        ...
                                        <div class="pt-2">
                                            ...
                                            @else
                                                <input type="radio" class="form-control-check"
                                                    name="willing_to_settle_abroad" id="willing_to_settle_abroad_yes"
                                                    value="Yes"
                                                    @if ($user->willing_to_settle_abroad == 'Yes') {{ 'checked' }} @endif>
                                                <label for="willing_to_settle_abroad_yes">Yes</label>
                                                <input type="radio" class="form-control-check"
                                                    name="willing_to_settle_abroad" id="willing_to_settle_abroad_no"
                                                    value="No"@if ($user->willing_to_settle_abroad == 'No') {{ 'checked' }} @endif>
                                                <label for="willing_to_settle_abroad_no">No</label>
                                            @endif
                                        ...
                                        <div class="pt-2">
                                            ...
                                            @else
                                                <input type="radio" class="form-control-check"
                                                    name="willing_to_marry_having_strictly_jain_foods"
                                                    id="willing_to_marry_having_strictly_jain_foods_yes" value="Yes"
                                                    @if ($user->willing_to_marry_having_strictly_jain_foods == 'Yes') {{ 'checked' }} @endif>
                                                <label for="willing_to_marry_having_strictly_jain_foods_yes">Yes</label>
                                                <input type="radio" class="form-control-check"
                                                    name="willing_to_marry_having_strictly_jain_foods"
                                                    id="willing_to_marry_having_strictly_jain_foods_no" value="No"
                                                    @if ($user->willing_to_marry_having_strictly_jain_foods == 'No') {{ 'checked' }} @endif>
                                                <label for="willing_to_marry_having_strictly_jain_foods_no">No</label>
                                            @endif
                        ...
                        <div class="row m-0 mt-5">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group pt-3">
                                        ...
                                        <input type="text" name="mumbai_contact_name" id="mumbai_contact_name"
                                            value="{{ old('mumbai_contact_name') ?? $user->mumbai_contact_name }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group pt-3">
                                        ...
                                        <input type="text" name="mumbai_contact_mobile" id="mumbai_contact_mobile"
                                            value="{{ old('mumbai_contact_mobile') ?? $user->mumbai_contact_mobile }}"
                                    ...
                                    <div class="form-group pt-3">
                                        ...
                                        <select class="form-control" name="mumbai_contact_family_relation"
                                            ...
                                            @else
                                                @foreach (App\Models\User::FAMILY_RELATION as $fr)
                                                    <option value="{{ $fr }}"
                                                        @if ($user->mumbai_contact_family_relation == $fr) {{ 'selected' }} @endif>
                                                        {{ $fr }}
                                                    </option>
                                                @endforeach
                                            @endif
                                ...
                                <div class="col-md-8 mt-md-3 mt-0">
                                    <div class="form-group pt-3">
                                        ...
                                        <textarea name="mumbai_contact_address" id="mumbai_contact_address" placeholder="Enter Full Address" class="form-control" minlength="3"
                                            maxlength="120">{{ old('mumbai_contact_address') ?? $user->mumbai_contact_address }}</textarea>
                            ...
                            {{-- <div class="row m-0 mt-5 justify-content-center">
                                <legend class="text-center h3"> Confirmation</legend>
                                <div class="col-md-10 mt-3">
                                    <div class="box-white p-md-5 p-2">
                                        <ol>
                                            ...
                                            <li class="mt-2"> It's our duty & responsibility to check correctness of
                                                candidates details</li>
                                            <li class="mt-2">Center will not have any responsibility and liabilities for
                                                the same.</li>
                                            <li class="mt-2">We agree for registration in website.</li>
                                            <li class="mt-2 w-break"> Misbehavior/Misconduct/Harassment will result into
                                                Police Complaint & Termination of Membership
                                                without any refund of Registration Fees.</li>
                                            <li class="mt-2"> Subject to Mumbai Jurisdiction only</li>
                                        </ol>
                                        <div class="mt-5 agree-checkbox">
                                            <input type="checkbox" class="form-group-check form-group agree-check"
                                                value="1"
                                                @if ($user->confirmation == '1') {{ 'checked' }} @endif
                                                name="confirmation" required>
                                            <small class="agree-text d-inline-block">I have read and agree to the terms and
                                                conditions.</small>
                                        </div>
                                    </div>
                                </div>
