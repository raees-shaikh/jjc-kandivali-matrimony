...
@section('content')
    ...
    <section class="breadcrumb-area">
        ...
        <div class="container">
            <div class="res-add">
                <h4 class="mt-5 text-center font-weight-300"><i>Registration Charges Rs. 750/- (Valid For Three Years)</i>
                </h4>
            </div>
        </div>
    </section>
    <section class="mb-4 px-md-0 px-3 ">
        <div class="register-form-container container p-3 py-4 p-md-5 custom-padding-for-desk">
            <legend class="font-weight-600 mb-3">Personal Details</legend>
            <div class="register-form-wrap">
                <form id="register-form" action="{{ route('frontend.form-one.update') }}" method="POST"
                    ...
                    <div class="row ">
                        <div class="col-xl-4 col-md-6">
                            ...
                            <div class="form-group pt-3">
                                <label for="mobile_number2">Mobile Number</label>
                                <input type="text" id="mobile_number2" placeholder="Enter You Mobile No."
                                    class="form-control" minlength="10" maxlength="10" value="{{ $user->mobile }}" disabled>
                            </div>

                            <div class="form-group pt-3">
                                <label for="dob">Date of Birth - Time</label>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="place_of_birth" id="place_of_birth"
                                    placeholder="Enter your place" class="form-control" minlength="3" maxlength="30"
                        ...
                        <div class="col-xl-4 col-md-6">
                            ...
                            <div class="form-group pt-4">
                                ...
                                <div class="pt-2">
                                    @if (old('gender'))
                                        ...
                                        <label class="hide-star form-check-label d-inline-block" for="gender_male">
                                            Male
                                        </label>
                                        <input class="form-check-input d-inline-block" type="radio" name="gender"
                                            id="gender_female" value="female"
                                            @if (old('gender') == 'female') {{ 'checked' }} @endif required>
                                        <label class="hide-star form-check-label d-inline-block" for="gender_female">
                                            Female
                                        </label>
                                    @else
                                        <input class="form-check-input d-inline-block" type="radio" name="gender"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <input type="text" name="native_place" id="native_place"
                                    placeholder="Enter your place" class="form-control" minlength="3"
                                    maxlength="30"value="{{ old('native_place') ?? $user->native_place }}" required>
                            ...
                            <div class="form-group pt-4">
                                ...
                                <input type="text" name="mobile_number" id="mobile_number"
                                    ...
                                    maxlength="10" value="{{ old('mobile_number') ?? $user->alternative_mobile }}"
                                    required>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-md-0 pt-3">
                                ...
                                <input accept="image/png, image/jpeg" name="profile_image" type="file"
                                    id="input-file-now-custom-2" class="dropify" data-height="250">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3 res-add">
                                ...
                                <select class="form-control" name="martial_status" required>
                                    ...
                                    @else
                                        @foreach (App\Models\User::MARTIAL_STATUS as $ms)
                                            <option value="{{ $ms }}"
                                                @if ($user->martial_status == $ms) {{ 'selected' }} @endif>
                                                {{ $ms }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group pt-3">
                                ...
                                <select class="form-control" name="status_of_children" id="status_of_children">
                                    ...
                                    @else
                                        @foreach (App\Models\User::CHILDREN_STATUS as $cs)
                                            <option value="{{ $cs }}"
                                                @if ($user->status_of_children == $cs) {{ 'selected' }} @endif>
                                                {{ $cs }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group pt-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control" aria-label="Small" name="no_of_children"
                                        value="{{ old('no_of_children') ?? $user->no_of_children }}" required min="0" max="99">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border-0 bg-white text-black h-100 ">
                            ...
                            <div class="form-group pt-3">
                                ...
                                <select class="form-control" id="caste" name="caste" required>
                                    ...
                                    @else
                                        @foreach (App\Models\User::CASTE as $c)
                                            <option value="{{ $c }}"
                                                @if ($user->caste == $c) {{ 'selected' }} @endif>
                                                {{ $c }}
                                            </option>
                                        @endforeach
                                    @endif
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="sub_caste" id="sub_caste" placeholder="Enter Your Sub Caste"
                                    class="form-control" value="{{ old('sub_caste') ?? $user->sub_caste }}"
                            ...
                            <div class="form-group pt-3 res-add">
                                ...
                                <select class="form-control" id="mother_tongue" name="mother_tongue" required>
                                    ...
                                    @else
                                        @foreach (App\Models\User::MOTHER_TONGUE as $mt)
                                            <option value="{{ $mt }}"
                                                @if ($user->mother_tongue == $mt) {{ 'selected' }} @endif>
                                                {{ $mt }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group pt-3">
                                ...
                                <div class="pt-2">
                                    ...
                                    @else
                                        <input class="form-check-input d-inline-block" type="radio" name="manglik"
                                            id="manglik_yes" value="1"
                                            @if ($user->manglik == '1') {{ 'checked' }} @endif>
                                        <label class="form-check-label d-inline-block" for="manglik_yes">
                                            Yes
                                        </label>
                                        <input class="form-check-input d-inline-block" type="radio" name="manglik"
                                            id="manglik_no" value="0"
                                            @if ($user->manglik == '0') {{ 'checked' }} @endif>
                                        <label class="form-check-label d-inline-block" for="manglik_no">
                                            No
                                        </label>
                                    @endif
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="height" id="height" placeholder="Enter Your Height"
                                    class="form-control" value="{{ old('height') ?? $user->height }}" required>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="weight" id="weight" placeholder="Enter Your Weight"
                                    class="form-control" value="{{ old('weight') ?? $user->weight }}" required>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <select class="form-control" id="blood_group" name="blood_group">
                                    ...
                                    @else
                                        @foreach (App\Models\User::BLOOD_GROUP as $bg)
                                            <option value="{{ $bg }}"
                                                @if ($user->blood_group == $bg) {{ 'selected' }} @endif>
                                                {{ $bg }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group pt-3 res-add">
                                ...
                                <div class="pt-2">
                                    @if (old('handicap'))
                                        ...
                                        <label class="hide-star form-check-label d-inline-block" for="handicap_yes">
                                            Yes
                                        </label>
                                        <input class="form-check-input d-inline-block" type="radio" name="handicap"
                                            id="handicap_no" value="0"
                                            @if (old('handicap') == '0') {{ 'checked' }} @endif required>
                                        <label class="hide-star form-check-label d-inline-block" for="handicap_no">
                                            No
                                        </label>
                                    @else
                                        <input class="form-check-input d-inline-block" type="radio" name="handicap"
                                            id="handicap_yes" value="1"
                                            @if ($user->handicap == '1') {{ 'checked' }} @endif required>
                                        <label class="hide-star form-check-label d-inline-block" for="handicap_yes">
                                            Yes
                                        </label>
                                        <input class="form-check-input d-inline-block" type="radio" name="handicap"
                                            id="handicap_no" value="0"
                                            @if ($user->handicap == '0') {{ 'checked' }} @endif required>
                                        <label class="hide-star form-check-label d-inline-block" for="handicap_no">
                                            No
                                        </label>
                                    @endif
                        ...
                        <div class="col-xl-4 col-md-6 ">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="handicap_details" id="handicap_details"
                                    ...
                                    maxlength="30" value="{{ old('handicap_details') ?? $user->handicap_details }}">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3 res-add">
                                ...
                                <textarea type="text" name="residential_address" id="residential_address" class="form-control" rows="4"
                                    minlength="3" maxlength="120" required>{{ old('residential_address') ?? $user->residential_address }}</textarea>
                    ...
                    <legend class="font-weight-600 my-4">Education & Occupation Details</legend>
                    <div class="row">
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3 res-add">
                                ...
                                <select name="qualification" class="form-control" required>
                                    ...
                                    @else
                                        @foreach (App\Models\User::QUALIFICATION as $e)
                                            <option value="{{ $e }}"
                                                @if ($user->qualification == $e) {{ 'selected' }} @endif>
                                                {{ $e }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group pt-3 res-add">
                                ...
                                <select name="education_medium" class="form-control" required>
                                    ...
                                    @else
                                        @foreach (App\Models\User::EDUCATION_MEDIUM as $em)
                                            <option value="{{ $em }}"
                                                @if ($user->education_medium == $em) {{ 'selected' }} @endif>
                                                {{ $em }}
                                            </option>
                                        @endforeach
                                    @endif
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="education_details" id="education_details"
                                    ...
                                    maxlength="60" value="{{ old('education_details') ?? $user->education_details }}"
                                    required>
                            ...
                            <div class="form-group pt-3 res-add">
                                ...
                                <select class="form-control" name="occupation" required>
                                    ...
                                    @else
                                        @foreach (App\Models\User::OCCUPATION as $occu)
                                            <option value="{{ $occu }}"
                                                @if ($user->occupation == $occu) {{ 'selected' }} @endif>
                                                {{ $occu }}
                                            </option>
                                        @endforeach
                                    @endif
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="occupation_details" id="occupation_details"
                                    ...
                                    maxlength="120"
                                    value="{{ old('occupation_details') ?? $user->occupation_details }}">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <textarea type="text" name="occupation_address" id="occupation_address" class="form-control" rows="2"
                                    minlength="3" maxlength="120">{{ old('occupation_address') ?? $user->occupation_address }}</textarea>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control" aria-label="Small"
                                        name="no_of_married_sisters" id="no_of_married_sisters" required
                                        value="{{ old('no_of_married_sisters') ?? $user->married_sisters }}"
                                        min="0" max="99">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border-0 bg-white text-black h-100 ">
                                            <i class="fa-solid fa-angle-right"></i>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control" aria-label="Small"
                                        ...
                                        value="{{ old('no_of_unmarried_sisters') ?? $user->unmarried_sisters }}"
                                        min="0" max="99">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border-0 bg-white text-black h-100 ">
                                            <i class="fa-solid fa-angle-right"></i>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group pt-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control" aria-label="Small"
                                        name="no_of_married_brothers" required
                                        value="{{ old('no_of_married_brothers') ?? $user->married_brothers }}"
                                        id="no_of_married_brothers" min="0" max="99">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border-0 bg-white text-black h-100 ">
                                            <i class="fa-solid fa-angle-right"></i>
                                        </span>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="number" class="form-control" aria-label="Small"
                                        ...
                                        value="{{ old('no_of_unmarried_brothers') ?? $user->unmarried_brothers }}"
                                        min="0" max="99">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border-0 bg-white text-black h-100 ">
                                            <i class="fa-solid fa-angle-right"></i>
                    ...
                    <div class="text-center">
                        ...
                        btn-block px-5 py-2 rounded mt-5">
                            Next
                        </button>
                    </div>
                </form>
