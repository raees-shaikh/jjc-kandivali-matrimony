...
?>
        <form action="<?= $this->url; ?>" id="payment_form_submit" method="post">
            <input type="hidden" id="surl" name="surl" value="<?= route('frontend.payment.success') ?>" />
            <input type="hidden" id="furl" name="furl" value="<?= route('frontend.payment.failed') ?>" />
            ...
            <button class="pay-now h4 my-3 box" type="submit">Pay Now</button>
        </form>
